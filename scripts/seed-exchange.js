...
module.exports = async function(callback) {
    try {
        ...
        console.log(`Transferred ${amount} tokens from ${sender} to ${receiver}`) //backticks
        ...
        amount = 1
        await exchange.depositEther({ from: user1, value: ether(amount) }) //ether(amount)
        ...
        console.log(`Deposited ${amount} token from ${user2}`)
        ...
        // Wait 1 second based on how timestamps work
        await wait(1)
        ...
        // Wait 1 second. Smallest resolution we have on the blockchain now
        await wait(1)
